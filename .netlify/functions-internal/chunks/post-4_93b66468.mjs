...
const html = "<p>This post should show up with my other blog posts, because <code>Astro.glob()</code> is returning a list of all my posts in order to create my list.</p>";
				...
				const frontmatter = {"title":"My Fourth Blog Post","pubDate":"2022-08-08T00:00:00.000Z","description":"This post will show up on its own!","author":"Astro Learner","image":{"url":"https://docs.astro.build/default-og-image.png","alt":"The word astro against an illustration of planets and stars."},"tags":["astro","successes"]};
