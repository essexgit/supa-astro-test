...
const html = "<p>It wasn’t always smooth sailing, but I’m enjoying building with Astro. And, the <a href=\"https://astro.build/chat\">Discord community</a> is really friendly and helpful!</p>";
				...
				const frontmatter = {"title":"My Third Blog Post","pubDate":"2022-07-15T00:00:00.000Z","description":"I had some challenges, but asking in the community really helped!","author":"Astro Learner","image":{"url":"https://docs.astro.build/assets/rays.webp","alt":"Thumbnail of Astro rays."},"tags":["astro","learning in public","setbacks","community"]};
